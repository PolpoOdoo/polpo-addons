...
class QappsBarcodeReaderLine(models.TransientModel):
    ...
    reserved_availability = fields.Float(
        "Reservado", digits="Product Unit of Measure", default=0, readonly=True,
        help="Cantidad demandada del producto en el traslado, contra la que se compara "
        "la cantidad controlada.",
    )
    qty_checked = fields.Float(
        "Controlado", digits="Product Unit of Measure", default=0, readonly=True,
