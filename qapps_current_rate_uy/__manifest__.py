{
    "name": "Tasa de Cambio Uruguay - BCU - QApps",
    "summary": "Importa automáticamente del BCU la cotización diaria de todas las monedas activas (USD, EUR, UI)",
    "description": """
        ...
        Indexada (código BCU "U.I.") se carga con TCC directo.
